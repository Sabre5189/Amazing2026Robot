...
public class IndexerSubsystem extends SubsystemBase {
  ...
  private final SparkMax indexer = new SparkMax(30, MotorType.kBrushless);
  ...
  public IndexerSubsystem() {
    closedLoopController = indexer.getClosedLoopController();
    ...
    indexmotorConfig.closedLoop.maxMotion
     ...
     * mid-operation.
     */
    indexer.configure(indexmotorConfig, ResetMode.kResetSafeParameters, PersistMode.kNoPersistParameters);
