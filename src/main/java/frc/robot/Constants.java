...
//  }
  ...
  public static final class ShooterConstants {
    ...
    public static final double minVelocity = 100;

    private static final double shooterIncrement = 0.1;
    public static final double kShooterUp = shooterIncrement;
    public static final double kShooterDown = shooterIncrement * -1;
    public static final double kShooterIncrementPeriod = .5;  // tune this for debouncing
